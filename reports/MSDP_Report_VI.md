...
Đây là phần mềm nghiên cứu, không phải khuyến nghị đầu tư. Non-stationarity, limited samples, transaction costs, model/seed sensitivity and time-series dependence constrain interpretation. Conformal coverage is empirical; no iid finite-sample guarantee is claimed. A forecast profile across horizons is not a future price path.
